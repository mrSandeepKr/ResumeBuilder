...
struct PdfViewModel {
    ...
    static var defaultInstance: PdfViewModel {
        let pageSize = CGSize(width: 8.5 * 72.0, height:11 * 72.0)
        
        return PdfViewModel(pageSize: pageSize, content: getContent)
    }
    ...
    static var getContent: PdfComponent {
        ...
        return VerticalPdfComponent(subComponents: [
                                    HorizontalPdfComponent(widthRatio: 1.0, subComponents: [
                                        ...
                                        ElementPdfComponent(widthRatio: 0.2, element: ImagePdfElement(imageSize: 100,
                                                                                                      isRounded: true,
